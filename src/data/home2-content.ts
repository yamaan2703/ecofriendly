// Home 2 Content - Completely New Premium Wellness & Luxury Theme
import {
  Crown,
  Gem,
  Award,
...
export const home2Content = {
  ...
  features: {
    ...
    items: [
      {
        title: "Diamond-Grade Bristles",
        description: "Ultra-premium bristles infused with diamond dust for superior cleaning power and gentle whitening effect.",
        image: "/images/Artboard_1.png",
        icon: "Gem",
        benefits: ["Diamond infusion", "Superior whitening", "Gentle cleaning"]
      },
      {
        title: "Ergonomic Luxury Handle",
        description: "Hand-polished bamboo handle with ergonomic curves designed for perfect grip and ultimate comfort.",
        image: "/images/right_brush.png",
        icon: "Crown",
        benefits: ["Hand-polished finish", "Ergonomic curves", "Ultimate comfort"]
      },
      {
        title: "Premium Gift Set",
        description: "Comes in a beautiful luxury box perfect for gifting, with individual protective sleeves for each brush.",
        image: "/images/brush_set.png",
        icon: "Gift",
        benefits: ["Luxury packaging", "Gift-ready", "Protective sleeves"]
      },
      {
        title: "Lifetime Guarantee",
        description: "Premium quality construction backed by our lifetime satisfaction guarantee and premium customer service.",
        image: "/images/brush.png",
        icon: "Award",
        benefits: ["Lifetime guarantee", "Premium service", "Quality construction"]
      }
    ]
  },
  ...
  features3: [
    {
      icon: "/images/material_certified.png",
      label: "Premium Quality",
      description: "Certified luxury materials"
    },
    {
      icon: "/images/leaves_1.png",
      label: "Ultra Gentle",
      description: "Perfect for sensitive gums"
    },
    {
      icon: "/images/teeth.png",
      label: "Whitening Effect",
      description: "Natural whitening properties"
    },
    {
      icon: "/images/Return_box.png",
      label: "Luxury Guarantee",
      description: "Premium satisfaction promise"
    }
  ],
  ...
  showcase: {
    ...
    description: "Transform your daily oral care routine into a luxurious wellness experience with our premium collection that combines sustainability with unmatched quality.",
    images: [
